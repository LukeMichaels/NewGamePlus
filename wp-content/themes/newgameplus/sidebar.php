...
<aside class="social-side-col">
	...
	<a href="<?php echo bp_loggedin_user_domain() ?>">
			...
			<!-- :::::::::: friend suggestions :::::::::: -->
			<div id="sidebar-friend-suggestions">
			
				<span class="sidebar-heading"><h3>Friend Suggestions</h3></span>
			
				<!-- display suggestions in unorderd list-->
				<p><?php $max=5;//how many suggestions at a time ?></p>
				<p><?php bp_show_friend_suggestions_list($max); ?></p>
				
			</div><!--friend-suggestions-->
