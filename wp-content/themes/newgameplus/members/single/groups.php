...
<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
	<ul>
		...
		<li id="create-group-personal-li" style="margin-top:-16px;">
			<?php _e( '', 'buddypress' ) ?>
			<?php if ( is_user_logged_in() ) : ?> &nbsp;
				<a id="create-group" href="<?php echo bp_get_root_domain() . '/' . BP_GROUPS_SLUG . '/create/' ?>"><?php _e( 'Create a Group', 'buddypress' ) ?>
				</a>
			<?php endif; ?></li>
