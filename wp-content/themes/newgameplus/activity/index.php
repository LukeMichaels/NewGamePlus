...
<?php get_header( 'buddypress' ); ?>
	<div id="social-pages-header">
		
		<?php do_action( 'bp_before_directory_activity_page' ); ?>

	</div><!--social-pages-header-->
	...
	<div id="social-container">
		...
		<div id="content">
			<div class="padder">
				...
				<!-- :::::::::: css is janky here, will need to fix :::::::::: -->
				<div class="item-list-tabs no-ajax" id="subnav" style="margin: -20px 0 15px !important;" role="navigation">
					<ul>
